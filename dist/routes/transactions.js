...
class TransactionRoutes {
    ...
    registeredRoutes() {
        ...
        this.router.post("/fund_wallet", (0, validator_1.default)(joiSchema_1.default.fundWallet, "body"), transactions_1.default.fundWallet);
        this.router.post("/transfer", (0, validator_1.default)(joiSchema_1.default.transferFunds, "body"), transactions_1.default.transferFunds);
        this.router.get("/balance", transactions_1.default.viewBalance);
        this.router.post("/withdrawal", (0, validator_1.default)(joiSchema_1.default.withdrawFunds, "body"), transactions_1.default.withdrawFunds);
        this.router.get("/transaction_history", transactions_1.default.viewTransactionHistory);
        this.router.get("/transaction_details/:transaction_id", transactions_1.default.viewTransactionDetails);
