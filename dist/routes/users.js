...
class UserRoutes {
    ...
    registeredRoutes() {
        this.router.post("/signup", (0, validator_1.default)(joiSchema_1.default.signup, "body"), users_1.default.signup);
        this.router.post("/login", (0, validator_1.default)(joiSchema_1.default.login, "body"), users_1.default.login);
        ...
        this.router.post("/profile/avatar", multer_1.default.single("avatar"), users_1.default.uploadAvatar);
        ...
        this.router.post("/forget_password", (0, validator_1.default)(joiSchema_1.default.forgetPassword, "body"), users_1.default.forgetPassword);
        this.router.post("/reset_password/:token", (0, validator_1.default)(joiSchema_1.default.resetPassword, "body"), users_1.default.resetPassword);
