...
Controller.uploadAvatar = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _b;
    try {
        const user = req.user;
        const buffer = yield (0, sharp_1.default)((_b = req.file) === null || _b === void 0 ? void 0 : _b.buffer).resize(250, 250).png().toBuffer();
        user.avatar = buffer;
        yield user.save();
...
Controller.viewAvatar = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = req.user;
        if (!user.avatar)
            throw new errorClass_1.default({
...
Controller.deleteAvatar = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const user = req.user;
    try {
...
Controller.logout = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        yield user.save();
        responseHelper_1.responseHelper.successResponse(res, "You've successfully logged out of this system");
    }
    catch (error) {
        next(error);
    }
});
Controller.forgetPassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
