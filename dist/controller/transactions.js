...
Controller.fundWallet = (req, res, next) =>
...
Controller.transferFunds = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      if (balance_before < amount)
        throw new errorClass_1.default({
          message: `Insufficient funds in your wallet. Please add money to your Balance to pay ${
            receiver === null || receiver === void 0 ? void 0 : receiver.name
          }`,
          statusCode: interfaces_1.responseStatusCodes.UNPROCESSABLE,
        });
...
Controller.withdrawFunds = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { amount } = req.body;
    const user = req.user;
    //Charges: 1% of the amount to be transferred
...
Controller.viewTransactionHistory = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _b, _c;
    const match = {};
    const sort = {};
    ...
    try {
      yield (_b = req.user) === null || _b === void 0
        ? void 0
        : _b.populate({
            path: "transactions",
            match,
...
Controller.viewTransactionDetails = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
Controller.totalAmountCredited = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _d, _e;
    try {
      //Get all transactions made by the user
      yield (_d = req.user) === null || _d === void 0
        ? void 0
        : _d.populate({
            path: "transactions",
...
Controller.totalAmountDebited = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      //Get all transactions made by the user
